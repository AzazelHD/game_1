...
struct RosterUnit
{
    ...
    bool isCritical = false;  // true = losing this unit is an instant defeat (see BattleSession::m_criticalUnits)
    bool recruited = true;
};
...
public:
    ...
    RosterUnit *recruit(std::string templatePath, std::string customName = "", bool isCritical = false);
